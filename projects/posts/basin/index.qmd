...
::: {#fig-1d layout-ncol=2}
![Iso-aceleration values in the Tunja basin](./1d.png){#fig-1d}
![Iso-aceleration values in the Tunja basin](./1d2.png){#fig-1d2}
...
![Iso-aceleration values in the Tunja basin](./basin effect.png){#fig-baeffect}