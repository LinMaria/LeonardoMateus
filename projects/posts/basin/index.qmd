...
These findings highlight the importance of selecting an appropriate modeling approach based on the specific geological features and objectives of the study. The two-dimensional model's ability to incorporate a higher level of detail makes it particularly suited for studies aiming to understand the nuanced interactions between seismic waves and complex geological structures, thereby providing more reliable data for seismic hazard analysis and mitigation planning.
